...
class SitesTest < ActiveSupport::TestCase
  test "enum lookups return the correct definition" do
  ...
  class FixUrlTest < ActiveSupport::TestCase
    ...
    test "cyrilic characters are escaped" do
    ...
    test "square brackets are escaped" do
    ...
    test "https is assumed when no scheme is present" do
  ...
  class FromGalleryUrlTest < ActiveSupport::TestCase
    ...
    test "works with furaffinity" do
    ...
    test "nil is returned when no definitions match" do
      result = Sites.from_gallery_url("https://example.com")
      assert_nil(result)
    end
  end

  test ".download_file handles redirects" do
  ...
  test ".download_file applies download headers" do
