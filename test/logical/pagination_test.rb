...
class PaginationTest < ActiveSupport::TestCase
  ...
  test "#records returns no results when there are no matches" do
  ...
  test "#records returns partial results when the last page can't be filled" do
  ...
  test "#pages handles pagination starting from page 1" do
  ...
  test "#pages handles pagination starting from page 6" do
  ...
  test "#pages handles pagination starting from the last page" do
  ...
  test "#pages handles lower/higher pages than available" do
