...
class SubmissionFileTest < ActiveSupport::TestCase
  class OriginalTest < ActiveSupport::TestCase
    ...
    test "must be attached on create" do
    ...
    test "prevents removal once attached" do
    ...
    test "blob is purged on errors in from_attachable" do
    ...
    test "files with undesired content types are ignored" do
      artist_submission = create(:artist_submission)
      file = Tempfile.new(binmode: true)
  ...
  test "submission_file is respected during pagination" do
  ...
  class SearchTest < ActiveSupport::TestCase
    test "results for larger by filesize absolute" do
    ...
    test "results for larger by filesize relative" do
    ...
    test "results for larger by dimensions" do
    ...
    test "results for already uploaded" do
    ...
    test "results for exact matches" do
    ...
    test "results for not uploaded" do
    ...
    test "results for zero sources" do
    ...
    test "results for zero artists" do
      sm1, sm2 = create_list(:submission_file, 2)
    ...
    test "results for zero sources mixed with zero artists" do
      sm1, sm2, sm3 = create_list(:submission_file, 3)
    ...
    test "similarity_score is respected" do
      sm1, sm2, sm3 = create_list(:submission_file, 3)
