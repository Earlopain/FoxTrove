...
class ArtistUrlTest < ActiveSupport::TestCase
  ...
  test "#search returns results when searching for missing api identifiers" do
  ...
  test "#enqueue_scraping for non-scraping url doesn't enqueue anything" do
    url = create(:artist_url, site_type: "kofi")
    url.enqueue_scraping
    assert_enqueued_jobs 0
  end

  test "#enqueue_scraping with missing api identifier doesn't enqueue anything" do
  ...
  test "#enqueue_scraping for a scraping url enqueues the scraping job" do
