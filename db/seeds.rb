...
update_or_create_site("twitter", {
  ...
  artist_url_formats: ["https://twitter.com/%<site_artist_identifier>s/"],
...
update_or_create_site("furaffinity", {
  ...
  artist_url_formats: ["https://www.furaffinity.net/user/%<site_artist_identifier>s/"],
...
update_or_create_site("inkbunny", {
  ...
  artist_url_formats: ["https://inkbunny.net/%<site_artist_identifier>s/"],
...
update_or_create_site("sofurry", {
  ...
  artist_url_formats: ["https://%<site_artist_identifier>s.sofurry.com/"],
...
update_or_create_site("deviantart", {
  ...
  artist_url_formats: [
    "https://www.deviantart.com/%<site_artist_identifier>s/",
    "https://%<site_artist_identifier>s.deviantart.com/",
  ],
...
update_or_create_site("artstation", {
  ...
  artist_url_formats: ["https://www.artstation.com/%<site_artist_identifier>s/"],
...
update_or_create_site("patreon", {
  ...
  artist_url_formats: ["https://www.patreon.com/%<site_artist_identifier>s/"],
...
update_or_create_site("pixiv", {
  ...
  artist_url_formats: [
    "https://www.pixiv.net/users/%<site_artist_identifier>s/",
    "https://www.pixiv.net/member.php?id=%<site_artist_identifier>s/",
  ],
...
update_or_create_site("weasyl", {
  ...
  artist_url_formats: [
    "https://www.weasyl.com/~%<site_artist_identifier>s/",
    "https://www.weasyl.com/profile/%<site_artist_identifier>s",
  ],
...
update_or_create_site("tumblr", {
  ...
  artist_url_formats: ["https://%<site_artist_identifier>s.tumblr.com/"],
...
update_or_create_site("reddit", {
  ...
  artist_url_formats: ["https://www.reddit.com/user/%<site_artist_identifier>s/"],
...
update_or_create_site("newsground", {
  ...
  artist_url_formats: ["https://%<site_artist_identifier>s.newgrounds.com/"],
  artist_identifier_regex: "[a-zA-Z0-9~]{1,20}",
...
update_or_create_site("vkontakte", {
  ...
  artist_url_formats: ["https://vk.com/%<site_artist_identifier>s/"],
...
update_or_create_site("instagram", {
  ...
  artist_url_formats: ["https://www.instagram.com/%<site_artist_identifier>s/"],
  artist_identifier_regex: "[a-zA-Z0-9_\.]{1,30}",
